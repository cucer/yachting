...
import styles from "../../assets/jss/material-kit-react/pages/about";
      ...
      <div className={classNames(classes.main, classes.mainRaised)}>
        <div className={classes.container}>
          <h4>
            <strong>
              <FormattedMessage
                id='app.page.about.title'
                defaultMessage='HAKKIMIZDA'
              />
            </strong>
          </h4>

          {ReactHtmlParser(
            intl.formatMessage({ id: "app.page.about.content" })
          )}
        </div>
      </div>
